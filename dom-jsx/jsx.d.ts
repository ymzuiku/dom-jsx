...
interface EventOptions {
  ...
  onmousedown?: (ev: HTMLElementCustomeEventMap["mousedown"]) => any;
  onmouseenter?: (ev: HTMLElementCustomeEventMap["mouseenter"]) => any;
  onmouseleave?: (ev: HTMLElementCustomeEventMap["mouseleave"]) => any;
  onmousemove?: (ev: HTMLElementEventMap["mousemove"]) => any;
  onmouseout?: (ev: HTMLElementCustomeEventMap["mouseout"]) => any;
  onmouseover?: (ev: HTMLElementCustomeEventMap["mouseover"]) => any;
  onmouseup?: (ev: HTMLElementCustomeEventMap["mouseup"]) => any;
  ...
  onpointercancel?: (ev: HTMLElementCustomeEventMap["pointercancel"]) => any;
  onpointerdown?: (ev: HTMLElementCustomeEventMap["pointerdown"]) => any;
  onpointerenter?: (ev: HTMLElementCustomeEventMap["pointerenter"]) => any;
  onpointerleave?: (ev: HTMLElementCustomeEventMap["pointerleave"]) => any;
  onpointermove?: (ev: HTMLElementEventMap["pointermove"]) => any;
  onpointerout?: (ev: HTMLElementCustomeEventMap["pointerout"]) => any;
  onpointerover?: (ev: HTMLElementCustomeEventMap["pointerover"]) => any;
  onpointerup?: (ev: HTMLElementCustomeEventMap["pointerup"]) => any;
  ...
  ontouchcancel?: (ev: HTMLElementCustomeEventMap["touchcancel"]) => any;
  ontouchend?: (ev: HTMLElementEventMap["touchend"]) => any;
  ontouchmove?: (ev: HTMLElementCustomeEventMap["touchmove"]) => any;
  ontouchstart?: (ev: HTMLElementCustomeEventMap["touchstart"]) => any;
